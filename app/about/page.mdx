...
The Aqueous Earth Catalog ("AQEC") is a map that shows movies and other moving image media texts that feature bodies of water. The point on the map shows the body of water where the movie was filmed. 
...
<a
  ...
  style={{ float: "right", marginLeft: "16px", marginBottom: "8px" }}
>
  <img
    src="/upenn_cargc_logo.png"
    alt="Center for Advanced Research in Global Communication"
    style={{ width: "140px", height: "auto", display: "block" }}
  />
</a>

The map is a creation of <a href="https://ennurijo.com">Ennuri Jo</a> (she/her), yours truly, a film and media studies scholar based in Los Angeles and Philadelphia. This map and its partner project Media Mapper were funded by the <a href="https://www.asc.upenn.edu/research/centers/center-for-advanced-research-in-global-communication">Center for Advanced Research in Global Communication</a> at the University of Pennsylvania.

<p style={{ clear: "both", marginTop: "0.5rem", marginBottom: 0 }}>
AQEC and its base application <a href="https://mediamapper.app" target="_blank" rel="noopener noreferrer">Media Mapper</a> are open source projects, designed by Ben Tyler at <a href="https://www.lostcreekdesigns.co/" target="_blank" rel="noopener noreferrer">Lost Creek Designs</a>. Visit Media Mapper&apos;s project website <a href="https://mediamapper.app"> here </a> to learn more and check out media maps created by other scholars and artists. The original Github repo for Media Mapper can be found <a href="https://github.com/Aqueous-Earth-Catalog-Team/media-mapper" target="_blank" rel="noopener noreferrer">here</a>.
</p>

## Can I contribute to the Aqueous Earth Catalog?

Absolutely! If there is a movie you'd like to see on this map, you can fill out this <a href="https://forms.gle/CUUNNyzKtrusbEfk9"> form</a>. Thank you for your contribution!
...
## Is it a standalone project or a part of a larger work?

The Aqueous Earth Catalog acts as a complementary project to my book-in-progress, tentatively titled Aqueous Image, which examines moving image texts that feature bodies of water that all concern, in a number of different discursive contexts, a disanthropocentric and nonexploitative mode of being-in-the-world. Bodies of water are however, as generative as they are as figurations, not imaginary. They are complex ecosystems that play critical roles in the larger natural and artificial environments. The Aqueous Earth Catalog is an attempt to address the material embeddedness of bodies of water and their filmic representations and serves as a complimentary object to this written study.<sup>3</sup> You can read more about my research <a href="https://ennurijo.com/research">here</a>.

## _Notes_

1. The Whole Earth publications are accessible for free at <a href="https://wholeearth.info"> wholeearth.info</a>. Steve Jobs is widely quoted to have said that the Whole Earth Catalog was the “internet before the internet.” Additionally, Homay King’s introduction of the Whole Earth Catalog includes a description that its directory “was in some ways a precursor to the crowd-sourced reviews and linking practices found some forty years later on the Internet.” Homay King, Virtual Memory: Time-based Art and the Dream of Digitality (Duke UP, 2015), 4.
